...
type Page='workspace'|'templates'|'tasks'|'review'|'account'|'admin'|'statistics'|'global-statistics'
const navigation=[{id:'workspace',name:'工作台',icon:House},{id:'templates',name:'模板库',icon:LayoutGrid},{id:'tasks',name:'任务中心',icon:ClipboardList},{id:'review',name:'结果检查',icon:ScanSearch},{id:'statistics',name:'我的统计',icon:BarChart3},{id:'global-statistics',name:'全站统计',icon:ChartNoAxesCombined},{id:'account',name:'账号设置',icon:UserRound},{id:'admin',name:'管理设置',icon:Settings2}] as const
