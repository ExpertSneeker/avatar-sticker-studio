...
type Page='stickers'|'workspace'|'templates'|'tasks'|'account'|'admin'|'statistics'|'global-statistics'|'users'|'organizations'|'shops'
const navigation=[{id:'workspace',name:'工作台',icon:House},{id:'stickers',name:'贴纸库',icon:StickerIcon},{id:'templates',name:'模板库',icon:LayoutGrid},{id:'tasks',name:'历史订单',icon:ClipboardList},{id:'shops',name:'店铺接入',icon:Building2},{id:'statistics',name:'统计',icon:BarChart3},{id:'account',name:'账号设置',icon:UserRound},{id:'users',name:'账户管理',icon:UserRound},{id:'organizations',name:'组织管理',icon:Building2},{id:'global-statistics',name:'全站统计',icon:ChartNoAxesCombined},{id:'admin',name:'管理设置',icon:Settings2}] as const
export default function App(){
  ...
  const [page,setPage]=useState<Page>(()=>new URLSearchParams(window.location.search).has('agiso')?'shops':'workspace'),[templates,setTemplates]=useState<TemplateSet[]>([]),[stickers,setStickers]=useState<Sticker[]>([]),[orders,setOrders]=useState<Order[]>([])
