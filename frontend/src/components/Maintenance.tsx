...
type Storage={total_bytes:number;used_bytes:number;free_bytes:number;app_bytes:number;pending_files:number}
type Plan={before:string;preview_token:string;order_count:number;item_count:number;file_count:number;file_bytes:number;blocked_count:number;legacy_unassigned_files:number;orders:{id:string;name:string;created_at:string}[]}
