...
export interface Draft {output_directory?:FileSystemDirectoryHandle;destination_locked?:boolean;id:string;file:File;name:string;template_ids:string[];print_settings:PrintSettings;upload_id?:string;client_token:string}
