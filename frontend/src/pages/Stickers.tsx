...
export function Stickers({stickers,canEdit,onRefresh}:{stickers:Sticker[];canEdit:boolean;onRefresh:()=>void}) {
 ...
 async function toggle(s:Sticker){try{await patch('/stickers/'+s.id,{active:!s.active});onRefresh()}catch(e){notice((e as Error).message,'error')}}
